...
declare const PRIMITIVE_TYPES: Set<"string" | "number" | "boolean" | "unknown" | "void">;
/**
 ...
 */
declare const getArrayResponseSchema: (imports: readonly {
  name: string;
}[], definition: string | undefined, toValueRef?: (typeName: string) => string) => ArrayResponseSchema | undefined;
/**
 ...
 */
declare const getZodNamespaceImportSource: (output: NormalizedOutputOptions) => string;
/** The namespace import a composed `zod.array(...)` expression requires. */
declare const getZodNamespaceImport: (output: NormalizedOutputOptions) => {
  name: string;
  values: boolean;
